...
from showsomething.views import HomePage, ReviewS9, ReviewS9Plus, DetailsS9, DetailsS9Plus, ContactusViewLowSpeed, ContactusView,  ReviewS9PlusLowSpeed, ReviewS9LowSpeed, BuyerViewLowSpeed, BuyerView ,mtplusView, DetailsS9LowSpeed, DetailsS9PlusLowSpeed, AskSpeed, lowSpeedView, MtpluslowSpeedView
...
urlpatterns = [
    ...
    url(r'^contactusLowSpeed/', ContactusViewLowSpeed, name='contactusUrlLowSpeed'),
